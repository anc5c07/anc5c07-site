...
last_modified_at: 2023-11-02T04:10:38
---
...
## tl;dr
- **Rhode Island Ave NE from 20th St NE to 24th St NE is an vital retail area** in our neighborhood, containing many important businesses and amenities, as well as many new homes coming online.
...
There are, inexplicably, crosswalk signs in the median at the mostly unmarked 22nd St crossing.
...
The progression on this matter is a good indicator of how things tend to work with DDOT; there are many things that appear to float around at the agency without being addressed until they're pushed into admitting a result with precise recognition of their purported operating procedures.
...
It had only become possible for TSI submissions to come directly from the public without marshalling from the SMD Commissioner (which was Commissioner Montague for both sides of the subject intersection at the time) since November 2021, and the new protocols were still shaky and subject to an unclear Commissioner veto. By September, we could be confident submissions would be yielding recommendations once new Commissioners were seated, and it was a good time to start loading up the pipeline with comprehensive (and experimentally ambitious) investigation requests.

Like most #All4Allie submissions, this TSI SR started under the communal first-in/first-out six-month investigation protocol in place from November 2021 through December 2022. Some of these SRs went through investigation (such as nearby speedhumps on Girard Pl, 25th St, and 26th St) and many others were "pooled" on 1/6/2023 for later consideration as part of [the quarterly prioritization scoring system that replaced first-in/first-out consideration](https://dcist.com/story/23/01/12/residents-upset-over-changes-to-traffic-safety-request-process/); until around May 2023, the TSI dashboard did not clearly indicated SRs in the "pool," so there was little case-by-case clarity on the status of these SRs.
...
I flagged to DDOT on 8/25/2023 during another round of emails Ms. Elmira initiated that additional asks were piling up in the pool of TSIs for future consideration to both emphasize issues created by the time lag and and issues created by poor feedback/grouping mechanisms in the TSI system for submissions redundant with open investigations. Again, we received no response.

On 10/24/2023, I issued a letter regarding speedhumps on the 2000 block of Hamlin St NE, which conditioned support specifically on keeping nearby investigations open. In response DDOT, send a comprehensive list of evaluations within 5C07 that remain ongoing, and their current status. This traffic signal assessment was not on the list; I immediately flagged it among the items that were missing:
...
While I did receive a response on other items in the list, this one was among the items still waiting internal response.
...
- an ANC meeting would not be a precondition for moving forward on the design, though it's the preferred method of discussing the matter with a safety engineer
...
Depending on what I eventually find, we may want to push back on the assessment and continue working for a full traffic signal. However, there are a lot of important improvements to the intersection we can likely get in scope for the HAWK signal design, which would then vastly improve the starting point for a future upgrade to a full traffic signal.
