...
last_modified_at: 2023-01-16T18:09:14
notes: footnotes
---
## tl;dr
...
### election procedure:
Summarizing 5C bylaws (Article 4, Sections 7-11):
- For each office, which will be addressed before the next office is addressed:
  - nominations occur; no limit to nominees. For each nominee:
    ...
    - a Commissioner must second (this can't be the nominee); no speech allowed for this
  - a vote/votes occur(s); ballots cannot be secret (per bylaws and also OAG ruling)
    - multiple rounds occur if needed; I am still unclear on whether nominees are voted on in sequence or it's one round and then a runoff round if needed to attain simple majority. Consulting some experts!
