...
last_modified_at: 2023-01-16T18:03:57
notes: footnotes
---
## tl;dr
...
### election procedure:
Summarizing bylaws (Article 4, Sections 7-11):
- For each office, which will be addressed before the next office is addressed
  - nominations occur; no limit to nominees
    - for each nominee:
      ...
      - a Commissioner must second (this can't be the nominee); no speech for allowed for this
