...
last_modified_at: 2023-01-16T18:50:28
notes: footnotes
---
## tl;dr
...
As a new Commission, 5F will be deliberating on brand new Bylaws, and Commissioner Bishop-Henchman [has done a lot of work](https://www.joeanc.com/#section_1fb72d518ab63773b714e7902d8dde31) on studying all the above guiding texts and existing Commission Bylaws across DC. This makes the 5F Bylaws and Procedures a great reference work for determining how to least ambiguously word changes, and look for improvements.

## Officers
Per [DC Code § 1–309.11(e)(1)](https://code.dccouncil.gov/us/dc/council/code/sections/1-309.11#(e)(1)) and 5C Bylaws Article 4, Section 1, officers must be elected from among the Commissioners in January. Specific Officer Duties are detailed in the 5C Bylaws, Article 5. The Officers are as follows:
...
- For each office, which will be addressed before the next office is addressed<sup>1</sup>:
  - nominations occur; no limit to nominees. For each nominee:
    ...
    - a Commissioner must second<sup>2</sup> (this can't be the nominee); no speech allowed for this
  - roll call vote occurs; each Commissioner names a nominee for the office or abstains<sup>3</sup>
  - roll call votes repeat<sup>4</sup> until one candidate receives the simple majority<sup>4</sup> of votes cast; abstentions do not count as votes cast in a simple majority

<div class="footnotes" role="doc-endnotes">
  <ol>
    <li tabindex="-2" style="outline: none; margin-bottom: 0px;">
      <p>Section 10 constrains Roberts, which gives an option of doing in sequence or all at once</p>
    </li>
    <li tabindex="-2" style="outline: none;">
      <p>Section 7 overrules Roberts, which generally doesn't require seconds</p>
    </li>
    <li tabindex="-2" style="outline: none;">
      <p>Roll call votes are governed by Roberts 46:42, with votes by name and abstentions allowed</p>
    </li>
    <li tabindex="-2" style="outline: none;">
...
## Meeting Scheduling
Per [DC Code § 1–309.11(b)(2)](https://code.dccouncil.gov/us/dc/council/code/sections/1-309.11#(b)(2)):
> To the extent possible, each Commission shall, at its first meeting of the calendar year, adopt a schedule of regular Commission meetings for the remainder of the calendar year.
...
These meetings have historically occurred on the third Wednesday of the month at 6pm, with multiple months off in the summer. There has been a 5C sequence of Wednesday meetings every month:
...
- **5F** will likely be doing third Tuesdays

5B and 5C meetings will likely conflict for the year outside of summer months, which is unfortunate for those of us at 5C07 surrounded by 5B on all sides with our community split by the boundary, but we'll make do.
