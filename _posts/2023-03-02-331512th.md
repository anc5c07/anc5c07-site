...
toc_icon: "bullseye"
toc_sticky: true
last_modified_at: 2023-04-01T21:36:09
---
...
It is unclear if this variance is still being pursued, an OP report submitted into the BZA case record on 3/24 indicated the developer had agreed to submit revised plans reflecting a change to the penthouse shape. While these hadn't be submitted by 4/1, they had submitted a filing deadline exemption in order to submit responses to this OP report.

### A/C Unit Noise/Location
A resident complained (aggressively) at the 4/7 ANC 5B meeting about noise from 12 air conditioning units being at unhealthy levels. While this seems unlikely to be a new, unprecedented, or actual problem, it was asked that the developer consider moving some units to the roof of the building. This request was included in both ANC 5B's report, and in OP's report. It appears this will make it into the final plans.
