...
toc_icon: "bullseye"
toc_sticky: true
last_modified_at: 2023-03-12T01:37:41
---
...
As of this writing, the case still only concerns variance for one parking space. It's expected that a second space will be added to this variance (to facilitate no parking spaces to be built for 12 units, regardless of computation method), and that another variance/exception will be necessary for [penthouse setback](#penthouse-setback) on one side. It was indicated at the 3/7 presentation that this wasn't anticipated to push the hearing date back.
