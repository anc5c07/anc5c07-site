...
toc_icon: "bullseye"
toc_sticky: true
last_modified_at: 2023-03-08T07:09:44
---
<div id="development-map" class="map-container"></div>
This project is in 5B03, which borders 5C07 across the 5B/5C boundary; I have no formal vote on this project.
{: .notice--warning}
...
- At the 3/7 5B meeting, the developer indicated they may also need penthouse setback relief due to penthouse shape
...
The building, as planned, has two cellar floors, each containing three homes. These floors receive light and egress through deep wells  at the exterior walls of the building. 
