...
toc_icon: "bullseye"
toc_sticky: true
last_modified_at: 2023-12-05T02:16:16
---
...
- [**I also testified** before the Council](/issues/20230227-ddothearing/) about this roadway and crash.
- **You can help advocate for** more mitigations; some [instructions below](#community-action).
- **As of October 2023, most mitigations remain "under evaluation"** and one, a raised crosswalk in front of Langdon Rec Center, is under work order production
...
### Community Action
As of March 2023, The Vision Zero investigation is ongoing. DDOT has (quietly) elevated various SRs around the investigation area into the active investigation set on [their dashboard](https://ddot.dc.gov/service/traffic-safety-input). While it is the agency's contention that the engineers will investigate installations in these areas in an objective manner using data and existing manuals/policy guidance, there is likely some capacity for tie-breaking if folks email in personal stories and asks. These could be sent to:

|field|recipient|role|email|
|To|Dalando Baker|DDOT Community Engagement Specialist for Ward 5|dalando.baker@dc.gov|
|To|Kelly Jeong-Olson|DDOT Community Engagement Supervisor|kelly.jeong-olson1@dc.gov|
|To|Linda Bailey|DDOT Vision Zero Coordinator|linda.bailey@dc.gov|
|To|Charlie Willson|DDOT Vision Zero staff|charlie.willson@dc.gov|
...
I believe the following results are imminently attainable:
