...
toc_icon: "bullseye"
toc_sticky: true
last_modified_at: 2023-03-25T23:33:35
---
...
### Community Action
The Vision Zero investigation is ongoing. DDOT has (quietly) elevated various SRs around the investigation area into the active investigation set on their dashboard. While it is the agency's contention that the engineers will investigate installations in these areas in an objective matter using data and existing manuals/policy guidance, there is likely some capacity for tie-breaking if folks email in personal stories and asks. These could be sent to:
