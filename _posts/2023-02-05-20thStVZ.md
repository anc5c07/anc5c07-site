...
#### Points of Interest, Discussed mitigations:
The walk started in Langdon Park by the Chuck Brown memorial.

##### Mid-block crossing:
Many mitigations and concerns were shared about the wide crosswalk that connects both sides of Langdon Park across 20th St. The crosswalk was recently moved south slightly to avoid conflict with curbside catch basins and allow for accessibility ramps on both side, which were installed concurrent with a cycle of sidewalk maintenance work.
