...
toc_icon: "bullseye"
toc_sticky: true
last_modified_at: 2023-03-12T17:13:11
---
...
- **raising the Langdon Rec Center crosswalk**, as DDOT indicated was likely
- **also flexpost-daylighting the Langdon Rec Center crosswalk**; DDOT was less committal on this point
- **installing a stop sign camera at 20th/Hamlin**; an idea DDOT indicated was a possibility
- **flexposting the crosswalk in front of Woodridge Library** to prevent drivers from parking in it and taking the <90-degree turn off RIA so fast, which DDOT indicated was a possibility
...
Our goal should be having this mitigations installed *this paving season*, which runs from roughly May until October. It's too cold to perform these tasks in winter months.
